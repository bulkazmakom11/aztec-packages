...
export class AvmPersistableStateManager {
  ...
  // TODO(dbanks12): make these private once hack is removed in executor.ts
  ...
  constructor(
    ...
    parent?: AvmPersistableStateManager,
  ) {
   ...
   */
  public fork() {
    return new AvmPersistableStateManager(this.hostStorage, this.trace.fork(), this);
  }
